...
* Frontend Pods → Pods in namespaces labeled `ns=cassandra`
...
* Pods in the **`default` namespace → All Pods** in the `cassandra` namespace
...
kubectl exec frontend -- curl ${CASSANDRA_IP} #WORK
